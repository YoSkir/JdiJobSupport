...
namespace JDI_ReportMaker.ExcelWriter
{
    class DailyWeeklySettingWirter : ExcelWritter
    {
        ...
        {
            overwriteFile(target, cells[0][0], cells[0][1], cells[0][2], "姓 名: " + defaultSetting.Default.staff_name);
            overwriteFile(target, cells[1][0], cells[1][1], cells[1][2], "部門名稱: " + defaultSetting.Default.department);
